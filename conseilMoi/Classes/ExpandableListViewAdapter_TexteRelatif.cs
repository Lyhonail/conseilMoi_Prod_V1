...
{
    public class ExpandableListViewAdapter_TexteRelatif : BaseExpandableListAdapter
    {
        ...
        public ExpandableListViewAdapter_TexteRelatif(Context context, List<string> listGroup, Dictionary<string,List<string>>lstChild)
        {
