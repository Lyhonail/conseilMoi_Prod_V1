...
{
    public class ExpandableListViewAdapter_DetailProduit : BaseExpandableListAdapter
    {
        ...
        public ExpandableListViewAdapter_DetailProduit(Context context, List<string> listGroup, Dictionary<string,List<string>>lstChild)
        {
        ...
        public override View GetChildView(int groupPosition, int childPosition, bool isLastChild, View convertView, ViewGroup parent)
        {
            if(convertView == null)
            {
                ...
                convertView = inflater.Inflate(Resource.Layout.item_layout_detail_produit, null);
            }
        ...
        public override View GetGroupView(int groupPosition, bool isExpanded, View convertView, ViewGroup parent)
        {
            ...
            {
                LayoutInflater inflater = (LayoutInflater)context.GetSystemService(Context.LayoutInflaterService);
                convertView = inflater.Inflate(Resource.Layout.group_item_detail_produit, null);
            }
